package com.herprogramacion.carinsurance.fcm;
...
public class IFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendNewPromoBroadcast(RemoteMessage remoteMessage) {
        ...
        intent.putExtra("expiry_date", remoteMessage.getData().get("expira"));
        intent.putExtra("discount", remoteMessage.getData().get("descuento"));
